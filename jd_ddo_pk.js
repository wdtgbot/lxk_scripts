...
[task_local]
#京享值PK
0 10,11 * * * jd_ddo_pk.js, tag=每日抽奖, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

=====================Loon================
[Script]
cron "0 10,11 * * *" script-path=jd_ddo_pk.js, tag=京享值PK

====================Surge================
京享值PK = type=cron,cronexp="0 10,11 * * *",wake-system=1,timeout=3600,script-path=jd_ddo_pk.js

============小火箭=========
京享值PK = type=cron,script-path=jd_ddo_pk.js, cronexpr="0 10,11 * * *", timeout=3600, enable=true
*/
const $ = new Env('京享值PK');
