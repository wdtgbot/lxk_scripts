...
const JD_API_HOST = 'https://api.m.jd.com/', actCode = 'visa-card-001',linkId ='9WA12jYGulArzWS7vcrwhw';
...
function invite2() {
  ...
  let options = {
    url: "https://api.m.jd.com/",
    body: `functionId=TaskInviteService&body=${JSON.stringify({"method":"participateInviteTask","data":{"method":"participateInviteTask","data":{"channel":"1","inviterCode":"T8JQWR","type":2}}})}&appid=market-task-h5&uuid=&_t=${t}`,
    headers: {
      "Host": "api.m.jd.com",
      "Accept": "application/json, text/plain, */*",
      "Content-Type": "application/x-www-form-urlencoded",
...
function invite() {
  let t = +new Date()
  let inviterId = ["X94khyi9Nr6OAesWE5UeHw=="]
  var headers = {
    'Host': 'api.m.jd.com',
    'accept': 'application/json, text/plain, */*',
    'content-type': 'application/x-www-form-urlencoded',
...
function taskPostUrl(function_id, body) {
  return {
    url: `https://api.m.jd.com/?functionId=${function_id}&body=${JSON.stringify(body)}&_t=${new Date().getTime()}&appid=activities_platform&client=H5&clientVersion=1.0.0&h5st=20220107112528378%3B0916404074554531%3B15097%3Btk02wd5cf1d2318n5pY77UtbnPqvSpPudQ1tlxRne8q8tfCarY%2Bx%2BpCcI4HQVpfRDpMKHzYvps8Vq4KhXuo%2FsuJvBGW1%3B43aa1c059a394be595c49f670d945705f5c111bfbfc029154496579a29fa4d9f%3B3.0%3B1641525928378`,
    headers: {
      "Host": "api.m.jd.com",
      "Content-Type": "application/x-www-form-urlencoded",
      ...
      "Accept": "application/json, text/plain, */*",
      "User-Agent": UA,
      "Referer": `https://daily-redpacket.jd.com/?activityId=${linkId}&channel=syicon&sid=d2440e3d887883ece6d8bc396fdba0aw&un_area=22_193_57_075`,
      "Content-Length": "206",
      "Accept-Language": "zh-cn",
      "Cookie": cookie,
    }
