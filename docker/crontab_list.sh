...
# 赚京豆(微信小程序)
12 1 * * * node /scripts/jd_syj.js >> /scripts/logs/jd_syj.log 2>&1
# 京东快递签到
...
#美丽研究院兑换
1 7,12,19 * * * node /scripts/jd_beauty_exchange.js >> /scripts/logs/jd_beauty_exchange.log 2>&1
#京东保价
...
#京喜财富岛
10 3-20/1 * * * node /scripts/jd_cfd.js >> /scripts/logs/jd_cfd.log 2>&1
